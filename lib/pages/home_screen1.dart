                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: GestureDetector(
                                            onTap: () => {
                                              mm.changeMethodScreen('MM', Method.method3),
                                              _pageController.animateToPage(
                                                2,
                                                duration: Duration(milliseconds: 300),
                                                curve: Curves.easeInOut,
                                            ...
                                            child: AnimatedContainer(
                                              ...
                                              padding: const EdgeInsets.symmetric(vertical: 12),
                                              decoration: BoxDecoration(
                                                color: mm.manualScreenView == Method.method3
                                                    ? const Color.fromRGBO(33, 52, 72, 1)
                                                    : Color.fromRGBO(209, 238, 250, 1),
                                                borderRadius: BorderRadius.circular(8),
                                              ),
                                        ...
                                        Expanded(
                                          child: GestureDetector(
                                            onTap: () => {
                                              mm.changeMethodScreen('MM', Method.method4),
                                              _pageController.animateToPage(
                                                3,
                                                duration: Duration(milliseconds: 300),
                                                curve: Curves.easeInOut,
                                            ...
                                            child: AnimatedContainer(
                                              ...
                                              padding: const EdgeInsets.symmetric(vertical: 12),
                                              decoration: BoxDecoration(
                                                color: mm.manualScreenView == Method.method4
                                                    ? const Color.fromRGBO(33, 52, 72, 1)
                                                    : Color.fromRGBO(209, 238, 250, 1),
                                                borderRadius: BorderRadius.circular(8),
                                              ),
